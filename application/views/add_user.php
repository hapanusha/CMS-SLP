                            ...
                            <div class="card-body">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label>Officer Number</label> <span class="required">*</span>
                                        <input type="text" id='off_number' name='off_number' class="form-control" placeholder="Enter Officer Number" maxlength="5">
                                        <span class="required" id="chk_off"></span>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <!-- radio -->
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                            <input id='off_title' value="0" class="form-check-input" type="radio" name="off_title" >
                                            <label class="form-check-label">Mr. </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <input id='off_title' value="1" class="form-check-input" type="radio" name="off_title" >
                                            <label class="form-check-label">Mrs. </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <input id='off_title' value="2" class="form-check-input" type="radio" name="off_title" >
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id='off_nameWithInitial' name='off_nameWithInitial' class="form-control" placeholder="Enter Name with Initials">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id='off_callingName' name="off_callingName" class="form-control" placeholder="Enter your calling Name">
                                    </div>
                                </div>
                                ...
                                <!--                                <div class="col-sm-6">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label>Gender</label>
                                                                        <div class="form-check">
                                                                            <input id='off_gender' value="0" class="form-check-input" type="radio" name="gender" checked>
                                                                            <label class="form-check-label">Male </label>
                                                                        </div>
                                                                        <div class="form-check">
                                                                            <input id='off_gender' value="1" class="form-check-input" type="radio" name="gender" >
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label> Rank</label><span class="required">*</span>

                                        <select class="form-control" id="off_rank" name="off_rank">
                                            <option value="0">Select the Rank</option>
                                            <?php
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id='off_nic' name="off_nic" class="form-control" placeholder="Enter NIC" maxlength="12">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" id='off_contNo' name="off_contNo" class="form-control" placeholder="Enter Mobile Number"  maxlength="10"><br>
                                        <input type="number" id='off_contNoOthr' name="off_contNoOthr" class="form-control" placeholder="Enter alterntive contact Number" maxlength="10">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" id='off_email' name="off_email" class="form-control" placeholder="Enter Email">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <input type="text" id='off_address_no' class="form-control" placeholder="Enter home no/ name">
                                        <input type="text" id='off_address_street' class="form-control" placeholder="Enter street name">
                                        <input type="text" id='off_address_town' name="off_address_town" class="form-control" placeholder="Enter town">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id='off_hgtAcdmcQulfctn' name="off_hgtAcdmcQulfctn" class="form-control" placeholder="Enter Highest Academic Qualifiction Achieved">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id='off_othrQulfct' name="off_othrQulfct" class="form-control" rows="8" placeholder="Write your complain in brief"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id='off_userStatus' name="off_userStatus" class="form-control" value="1">
