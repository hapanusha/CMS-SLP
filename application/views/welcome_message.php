                ...
                <div class="card-tools">
                  ...
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" role="menu">
                      <a href="<?php echo base_url()."assets/";?>#" class="dropdown-item">Action</a>
                      <a href="<?php echo base_url()."assets/";?>#" class="dropdown-item">Another action</a>
                      <a href="<?php echo base_url()."assets/";?>#" class="dropdown-item">Something else here</a>
                      <a class="dropdown-divider"></a>
                      <a href="<?php echo base_url()."assets/";?>#" class="dropdown-item">Separated link</a>
                    </div>
                  </div>
        ...
        <div class="row">
          ...
          <div class="col-md-8">
              ...
              <div class="col-md-6">
                ...
                <div class="card">
                  ...
                  <div class="card-footer text-center">
                    <a href="<?php echo base_url()."assets/";?>javascript::">View All Users</a>
                  </div>
                  <!-- /.card-footer -->
                </div>
                <!--/.card -->
            ...
            <div class="card">
              ...
              <div class="card-footer clearfix">
                <a href="<?php echo base_url()."assets/";?>javascript:void(0)" class="btn btn-sm btn-info float-left">Place New Order</a>
                <a href="<?php echo base_url()."assets/";?>javascript:void(0)" class="btn btn-sm btn-secondary float-right">View All Orders</a>
              </div>
              <!-- /.card-footer -->
            </div>
            <!-- /.card -->
          ...
          <div class="col-md-4">
            ...
            <div class="card">
              ...
              <!-- /.card-body -->
              <div class="card-footer text-center">
                <a href="<?php echo base_url()."assets/";?>javascript:void(0)" class="uppercase">View All Products</a>
              </div>
              <!-- /.card-footer -->
            </div>
            <!-- /.card -->
